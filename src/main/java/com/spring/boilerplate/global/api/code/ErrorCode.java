...
public enum ErrorCode {
    ...
    NULL_POINT(400, "ERR_CLIENT_002", "Null Point Exception"),                      // NULL Point Exception 발생
    ...
    TOKEN_NOT_ALLOWED(401, "ERR_AUTH_002","Token is Not Allowed" ),                     // 허용 되지 않은 토큰
    ...
    NOT_MATCHED_REFRESH(401, "ERR_AUTH_009", "RefreshToken does not match"),            // DB의 RefreshToken과 일치 하지 않는 경우
    ...
    LOGIN_DUPLICATED(401, "ERR_AUTH_014", "Login was duplicated"),                      // 로그인이 중복되는 경우
